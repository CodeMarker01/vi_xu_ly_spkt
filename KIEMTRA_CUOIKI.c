...
VOID HIEN_THI_IMAGE()
{
   ...
   {
      SETUP_GLCD (GLCD_GRAPHIC_MODE);
      glcd_circle(63, 48, 15, 0, 1);
      glcd_rect (42, 5, 84, 30, 0, 1);
      GDRAM_VDK_TO_GDRAM_GLCD_ALL ();
   }
}
...
//**************************************************
VOID HT_4LED_7DOAN()
{ XUAT_4LED_7DOAN_4SO(MA7DOAN[GTCDT/10%10],MA7DOAN[GTCDT%10]&0x7f,0xA1, 0xA3);
}
