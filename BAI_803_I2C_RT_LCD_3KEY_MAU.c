...
VOID NHAP_NHAY_CON_TRO()
{
   SWITCH (GIATRI_MOD)
   {
      CASE 1: LCD_COMMAND(0X93); // GIAY
              BREAK;
      CASE 2: LCD_COMMAND(0X90);// PHUT
              BREAK;
      CASE 3: LCD_COMMAND(0X8D);// GIO
              BREAK;
      CASE 4: LCD_COMMAND(0XCD);// NGAY
              BREAK;
      CASE 5: LCD_COMMAND(0XD0);// THANG
              BREAK;
      CASE 6: LCD_COMMAND(0XD3);// NAM
              BREAK;
      DEFAULT:BREAK;
   }
}
